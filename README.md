...
-[Обзор существующих типов МБЛА](#Обзор-существующих-типов-МБЛА) 
...
# Обзор существующих типов МБЛА
Основную опасность представляют малые беспилотные летательные аппараты. Причем они могут использоваться не только в условиях военной конфронтации, но и в обычной гражданской среде, где их использование может быть связано с шпионажем или же попытками совершения противоправных действий таких как теракты, например. На таблице ниже можно ознакомиться с правонарушениями, в которых могут быть использованы МБЛА: ![image](https://github.com/DeSauzzz/Drone_detectio/assets/145459536/29e41eac-fd30-45b7-a194-c06ddd569c33) 
Так же стоит понимать и то, каких типов могут быть МБЛА. Таблица ниже иллюстрирует эти типы: ![image](https://github.com/DeSauzzz/Drone_detectio/assets/145459536/339369e5-a8fe-4229-b753-2168a3b201c7)
