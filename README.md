...
-[Детальное рассмотрение методов обнаружуния](#Детальное-рассмотрение-методов-обнаружения)
